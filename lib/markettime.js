...
/**
 * Deny a customer application — keep them unapproved and mark inactive in MarketTime.
 */
export async function denyCustomerForRepGroup(retailerID) {
  const customer = await getCustomer(retailerID);
