...
/**
 * MarketTime GET /items expects modifiedStartDate as epoch milliseconds (Java Long),
 * not YYYY-MM-DD. Accepts ISO date strings, Date objects, or numeric timestamps.
 */
 ...
 * Pass modifiedStartDate (ISO date, timestamp, or epoch ms) for delta sync.
 */
export const getItems = (params = {}) => {
  const query = { ...params };

  if (query.modifiedStartDate != null && query.modifiedStartDate !== '') {
    query.modifiedStartDate = toModifiedStartDateMs(query.modifiedStartDate);
  }
